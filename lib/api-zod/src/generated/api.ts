...
export const ListBookingsResponse = zod.object({
  bookings: zod.array(
    zod.object({
      ...
      isOffPlatform: zod.boolean().optional(),
      offPlatformClientName: zod.string().nullish(),
      offPlatformClientPhone: zod.string().nullish(),
      offPlatformClientEmail: zod.string().nullish(),
      offPlatformPaymentExternal: zod.boolean().optional(),
      washBayId: zod.string().nullish(),
      assignedOperatorId: zod.string().nullish(),
      discountAmountMinor: zod.number().optional(),
      discountDescription: zod.string().nullish(),
      location: zod
        .object({
          id: zod.string(),
          name: zod.string(),
